...
public class NewsLetterStepDefinitions extends StepDefinitions {
    ...
    public void userEntersInvalidEmail() {
        homePage.fillField("newsletter-input", "test.email.com");
    }

    @Given("User enters valid email")
    public void userEntersValidEmail() {
        homePage.fillField("newsletter-input", UUID.randomUUID() + "@test.com");
    }
